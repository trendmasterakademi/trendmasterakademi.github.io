      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="p-4 rounded-[var(--r-control)] bg-[var(--surface)] border border-[var(--rule)] text-[var(--ink-2)] text-xs sm:text-sm flex items-center gap-2.5">
            ...
            <span>
              {isTr ? (
                <>Tüm başvurular ve görüşmeler <Link to="/nda/" className="text-[var(--accent)] underline hover:text-[var(--accent-hover)] transition-colors min-h-[44px] inline-flex items-center">gizlilik sözleşmesi (NDA)</Link> kapsamındadır.</>
              ) : (
                <>All inquiries and consultations are protected under <Link to="/nda/" className="text-[var(--accent)] underline hover:text-[var(--accent-hover)] transition-colors min-h-[44px] inline-flex items-center">mutual non-disclosure agreement (NDA)</Link>.</>
              )}
            </span>
          </div>
        </div>
