// 12 Temel Teknik Terim Sözlüğü (Glossary for Digital Agencies)
export const glossaryTerms = [
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Lansman veya yüksek trafik anında sepetler donar, siparişler tamamlanamaz ve sunucu CPU kullanımı %100\'e fırlar. Müşteriniz sitenin çöktüğünü görür.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? 10 ürünlü sayfada sorunsuz çalışan site, 500 ürün girildiğinde 8 saniyede açılmaya başlar. Ajansınız "sunucu yetersiz" sanabilir, ancak asıl sorun verimsiz ORM kodudur.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Son kalan 1 adet stok aynı saniyede 2 farklı müşteriye satılır veya indirim kuponu aynı hesapta birden fazla kez kullandırılır.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Ziyaretçi ödeme yaparken butona sabırsızlanıp 3 kez bastığında müşterinin kartından 3 kez para çekilmesini önler.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Müşteri iyzico/Stripe ile ödeme yaptığında sitenizin siparişi otomatik "Ödendi"ye çekmesini sağlar. Webhook koptuğunda para tahsil edilir ama sipariş düşmez.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Ayrılan geliştiricinin bıraktığı karmaşık kodu, ajansınızın yeni projeler ekleyebileceği temiz ve dokümante bir altyapıya dönüştürür.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Geliştiricinin FTP üzerinden canlı dosyaları elle değiştirmesi gibi tehlikeli riskleri bitirir; her yayına alma sürecini sıfır hataya bağlar.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Müşterinizin canlıda hata görmesini engeller; revizyonları ve testleri canlı siteyi bozmadan ajans onayından geçirmenizi sağlar.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Kötü niyetli botların formları spamlamasını, SMS/e-posta kotanızı dakikalar içinde tüketmesini ve sunucunuzu kitlemesini engeller.',
  ...
  },
  {
    ...
    agencyImpact: {
      tr: 'Ajans için ne anlama gelir? Site ilk açıldığında mükemmel çalışır; ancak 2 gün sonra sunucu sebepsiz yere kilitlenir ve yeniden başlatma gerektirir.',
