    ...
    <div className="pt-32 pb-28 px-4 sm:px-6 md:px-12 max-w-4xl mx-auto text-[var(--ink)] font-sans">
      ...
      <section className="mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Item 1 */}
          <div className="p-6 rounded bg-[var(--surface)] border border-[var(--rule)] space-y-2 shadow-sm">
      ...
      <section className="mb-14">
        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded bg-[var(--surface)] border border-[var(--rule)] space-y-2 shadow-sm">
            ...
            <p className="text-xs sm:text-sm text-[var(--ink-muted)] leading-relaxed">
              {isTr 
                ? <>O iş için fiilen ödenen bedeli aşmaz ve dolaylı zararları — kâr kaybı, iş kaybı, itibar kaybı — kapsamaz. <strong className="text-[var(--ink)]">Kast ve ağır kusur bunun dışındadır</strong>; o hâllerde genel hükümler geçerlidir ve hiçbir sınırlama uygulanmaz.</>
                : <>It does not exceed the fee actually paid for that engagement and does not cover indirect losses — lost profit, lost business, reputational harm. <strong className="text-[var(--ink)]">Intent and gross negligence are excluded from this cap</strong>; in those cases general provisions apply and no limitation operates.</>}
            </p>
          </div>
      ...
      <section className="mb-14">
        ...
        <div className="p-6 sm:p-10 rounded bg-[var(--surface)] border border-[var(--rule)] text-[var(--ink)] space-y-8 text-xs sm:text-sm leading-relaxed font-sans select-text shadow-sm">
          ...
          <div className="text-center pb-6 border-b border-[var(--rule)] space-y-2">
            ...
            <p className="text-[var(--ink-muted)] text-xs font-mono">Trend Master Akademi — Standart B2B Sözleşme Metni</p>
          </div>

          {/* MADDE 1 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 1 — TARAFLAR</h3>
            ...
            <div className="p-4 rounded bg-[var(--paper)] border border-[var(--rule)] space-y-1 font-mono text-xs">
              <p className="text-[var(--ink)] font-bold">HİZMET SAĞLAYICI:</p>
              ...
              <p className="text-[var(--ink-muted)] italic">(Bundan sonra "TMA" olarak anılacaktır.)</p>
            </div>
            <div className="p-4 rounded bg-[var(--paper)] border border-[var(--rule)] space-y-1.5 font-mono text-xs overflow-hidden">
              <p className="text-[var(--ink)] font-bold">HİZMET ALAN:</p>
              <p className="flex items-baseline gap-1 overflow-hidden">
                <span className="shrink-0">Unvan:</span>
                <span className="overflow-hidden whitespace-nowrap text-[var(--ink-muted)] select-none">................................................................</span>
              </p>
              <p className="flex items-baseline gap-1 overflow-hidden">
              ...
              <p className="text-[var(--ink-muted)] italic pt-0.5">(Bundan sonra "AJANS" olarak anılacaktır.)</p>
            </div>
          ...
          {/* MADDE 2 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 2 — SÖZLEŞMENİN KONUSU</h3>
          ...
          {/* MADDE 3 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 3 — GİZLİ BİLGİ</h3>
          ...
          {/* MADDE 4 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 4 — GİZLİLİK YÜKÜMLÜLÜĞÜ (KARŞILIKLI)</h3>
          ...
          {/* MADDE 5 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 5 — BEYAZ ETİKET VE MÜŞTERİYE TEMAS YASAĞI</h3>
          ...
          {/* MADDE 6 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 6 — KİŞİSEL VERİLERİN KORUNMASI</h3>
          ...
          {/* MADDE 7 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 7 — ÜCRETSİZ TEŞHİS AŞAMASI</h3>
          ...
          {/* MADDE 8 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 8 — BEDEL, ÖDEME VE KAPSAM</h3>
          ...
          {/* MADDE 9 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 9 — FİKRİ MÜLKİYET VE MALİ HAKLARIN DEVRİ</h3>
          ...
          {/* MADDE 10 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 10 — DEVRALINAN KOD VE MEVCUT KUSURLAR</h3>
          ...
          {/* MADDE 11 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 11 — SORUMLULUK VE SINIRLARI</h3>
          ...
          {/* MADDE 12 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 12 — PERSONEL AYARTMA</h3>
          ...
          {/* MADDE 13 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 13 — SÜRE VE FESİH</h3>
          ...
          {/* MADDE 14 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 14 — MÜCBİR SEBEP</h3>
          ...
          {/* MADDE 15 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 15 — MUHTELİF HÜKÜMLER</h3>
          ...
          {/* MADDE 16 */}
          <div className="space-y-3">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">MADDE 16 — UYGULANACAK HUKUK VE YETKİ</h3>
          ...
          <div className="pt-6 border-t border-[var(--rule)] space-y-4">
            <h3 className="font-semibold font-serif text-[var(--ink)] text-sm sm:text-base">İMZA</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 font-mono text-xs">
              <div className="p-4 rounded bg-[var(--paper)] border border-[var(--rule)] space-y-2 overflow-hidden">
                <p className="text-[var(--ink)] font-bold">TMA</p>
              ...
              <div className="p-4 rounded bg-[var(--paper)] border border-[var(--rule)] space-y-2 overflow-hidden">
                <p className="text-[var(--ink)] font-bold">AJANS</p>
                <p className="flex items-baseline gap-1 overflow-hidden">
                  <span className="shrink-0">Unvan:</span>
                  <span className="overflow-hidden whitespace-nowrap text-[var(--ink-muted)] select-none">................................................................</span>
                </p>
